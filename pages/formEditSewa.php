...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container d-flex justify-content-between">
            <a class="navbar-brand" href="#">Edit Sewa Buku</a>
    ...
    <div class="container mt-5">
        ...
        <?php if (isset($_GET['status'])): ?>
            <div class="alert <?php echo $_GET['status'] == 'success' ? 'alert-success' : 'alert-danger'; ?>">
                <?php
                echo $_GET['status'] == 'success' ? 'Data penyewaan berhasil diperbarui!' : 'Gagal memperbarui data!';
                ?>
            </div>
        <?php endif; ?>
        ...
        <form action="prosesEditSewa.php?id=<?= htmlspecialchars($id); ?>" method="post">
            ...
            <button type="submit" name="update" class="btn btn-primary w-100">Update Sewa</button>
        </form>
    </div>
